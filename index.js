...
function emojiCursor(options) {
    /* 
    Credits: https://github.com/tholman
    */
...
function makeBackground() {
  let bgBox = document.querySelector('#text-bg');
  let textBox = bgBox.querySelector('.text-shadows');
  let cnt = Math.ceil(bgBox.getBoundingClientRect().height / textBox.getBoundingClientRect().height);
  for (let i = 0; i < cnt - 1; ++i) {
    bgBox.appendChild(textBox.cloneNode(true));
  }
}
